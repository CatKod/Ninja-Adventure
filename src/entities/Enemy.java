...
public abstract class Enemy extends Entity {
	...
	protected void updateAttackBoxFlip(int enemyType) {
		if (walkDir == RIGHT)
	...
	protected void updateAnimationTick() {
		...
		if (aniTick >= ANI_SPEED) {
			...
			if (aniIndex >= GetSpriteAmount(enemyType, state)) {
				if (enemyType == GOBLEM || enemyType == GOBLIN || enemyType == DEATH) {
					aniIndex = 0;
	...
	private boolean checkOutMap(Rectangle2D.Float hitbox) {
		return (hitbox.y > 13 * TILES_SIZE);
	}
